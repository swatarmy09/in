...
def scrape_internships():
    try:
        ...
        if not internships:
            internships = [
                {
                    "title": "PM Internship (Sample)",
                    "organization": "Government of India",
                    "description": "Sample internship data since MCA site is dynamic.",
                    "location": "New Delhi",
                    "skillsRequired": "Policy, Research",
                    "duration": "3 months",
                    "stipend": "₹10,000",
                    "imageUrl": "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=400",
                    "companyLogo": "https://upload.wikimedia.org/wikipedia/commons/5/55/Emblem_of_India.svg",
...
def index():
    return jsonify({
        ...
        "endpoints": {
            ...
            "/view": "View all internships from Firebase"
        }
    })
...
def view_handler():
    try:
        ...
        internships = [doc.to_dict() for doc in docs]
